 ...
 */
@Path("/visitemulation")
public final class VisitEmulationServer implements VisitEmulationInterface {
	/**
	...
	static Map<Position, Set<Position>> initTourWithPOIs() {
		...
		Position p19 = new Position(String.valueOf(19), new GPSPosition(48.860959, 2.335757), "Pyramide du Louvre");
