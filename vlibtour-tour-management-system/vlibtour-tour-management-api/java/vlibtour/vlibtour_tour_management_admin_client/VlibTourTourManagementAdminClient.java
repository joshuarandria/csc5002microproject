...
public final class VlibTourTourManagementAdminClient {
	...
	public static void main(final String[] args) throws Exception {
		...
		VlibTourTourManagement myVlib;
		try {
			InitialContext myContext = new InitialContext();
	        String pwd = System.getProperty("user.dir");
			System.out.println("pwd="+ pwd+"\n\n\n");
			myVlib = (VlibTourTourManagement) myContext.lookup("vlibtour.vlibtour_tour_management.api");
			System.out.println("Inserting Customers and Orders... " + myVlib.testInsert());
			System.out.println("Verifying that all are inserted... " + myVlib.verifyInsert());
